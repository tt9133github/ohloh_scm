...
describe "GitMisc" do
  ...
  it "fixture_repo_has_dereferenced_tags" do
    with_git_repository("git") do |git|
      ...
      tag_shas.any? { |sha| !git.commit_tokens.includes?(sha) }.should eq(true)
    end
  end

  it "tags" do
    with_git_repository("git") do |git|
      git.tags.should eq([["v1.0.0", "b6e9220c3cabe53a4ed7f32952aeaeb8a822603d", parse_time("2016-07-31T07:58:30+05:30")],
                          ["v1.1.0-lw", "2e9366dd7a786fdb35f211fff1c8ea05c51968b1", parse_time("2006-06-11T11:34:17-07:00")],
                          ["v2.1.0", "1df547800dcd168e589bb9b26b4039bff3a7f7e4", parse_time("2006-07-14T16:07:15-07:00")]])
    end
  end
  ...
  it "tags_reference_valid_commits" do
    with_git_repository("git") do |git|
      ...
      tag_shas.all? { |sha| git.commit_tokens.includes?(sha) }.should eq(true)
    end
  end
