...
describe "BzrMisc" do
  ...
  it "exist" do
    ...
    save_bzr.as(BzrAdapter).exist?.should be_falsey
  end

  it "ls_tree" do
    with_bzr_repository("bzr") do |bzr|
      bzr.ls_tree(bzr.head_token).sort.should eq(
  ...
  it "tags" do
    with_bzr_repository("bzr") do |bzr|
      time_1 = Time.parse("2009-02-04 00:25:40 +0000", "%F %T %z")
      time_2 = Time.parse("2011-12-22 18:37:33 +0000", "%F %T %z")
