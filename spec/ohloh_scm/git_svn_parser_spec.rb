...
describe 'GitSvnParser' do
  it 'test_basic' do
    assert_convert(OhlohScm::SvnParser, DATA_DIR + '/simple.svn_log', DATA_DIR + '/simple.ohlog')
  end

  it 'test_empty_array' do
    assert_equal([], OhlohScm::SvnParser.parse(''))
  end

  it 'test_empty_xml' do
    assert_equal("<?xml version=\"1.0\"?>\n<ohloh_log>\n</ohloh_log>\n", OhlohScm::SvnParser.parse('', writer: OhlohScm::XmlWriter.new))
  end
  ...
  it 'test_log_parser' do
    ...
    assert_equal Time.utc(2006, 6, 11, 18, 28, 0o0), revs[0].committer_date
  ...
  it 'test_log_embedded_in_comments' do
    ...
    assert_equal 21_932, revs[0].token
    assert_equal 21_931, revs[1].token
